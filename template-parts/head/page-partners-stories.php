...
<link href="<?php echo get_template_directory_uri(); ?>/assets/images/webclip.png?v=1786541200" rel="apple-touch-icon"><?php get_template_part('template-parts/head/partials/gtm-deferred'); ?>

<link href="https://trafigura-code.netlify.app/style.css" rel="stylesheet">
<link href="https://trafigura-code.netlify.app/partnerstory.css" rel="stylesheet">