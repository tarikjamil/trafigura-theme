...
<?php wp_enqueue_style('normalize', get_template_directory_uri() . '/assets/css/normalize.css', [], '1786541500'); ?>
<?php wp_enqueue_style('components', get_template_directory_uri() . '/assets/css/components.css', [], '1786541500'); ?>
<?php wp_enqueue_style('trafigura-staging', get_template_directory_uri() . '/assets/css/trafigura-staging.css', [], '1786541500'); ?>
...
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/partnerstory.css?v=1786541500" rel="stylesheet">